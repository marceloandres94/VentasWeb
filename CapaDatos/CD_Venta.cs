    ...
    public class CD_Venta
    {
        ...
        public Venta ObtenerDetalleVenta(int IdVenta)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                ...
                var NuevaCultura = CultureInfo.GetCultureInfo("es-CL");
                try
                {
                    oConexion.Open();
        ...
        public List<Venta> ObtenerUltimasVenta()
        {
            List<Venta> rptUltimasVenta = new List<Venta>();
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                SqlCommand cmd = new SqlCommand("usp_ObtenerUltimosCincoVenta", oConexion);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                try
                {
                    ...
                    return rptUltimasVenta;

                }
                catch (Exception ex)
                {
                    rptUltimasVenta = null;
                    return rptUltimasVenta;
                }
            }
        }
