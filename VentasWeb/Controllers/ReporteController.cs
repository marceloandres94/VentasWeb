...
namespace VentasWeb.Controllers
{
    public class ReporteController : Controller
    {
        ...
        public JsonResult ObtenerIndicadorVenta(string fechainicio, string fechafin, int idtienda)
        {

            List<IndicadorVenta> lista = CD_Reportes.Instancia.InidicadorVenta(Convert.ToDateTime(fechainicio), Convert.ToDateTime(fechafin), idtienda);
            return Json(lista, JsonRequestBehavior.AllowGet);
        }
